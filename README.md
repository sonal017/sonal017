...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Sonalkumar%20Singh&fontSize=52&fontColor=ffffff&fontAlignY=38&desc=Full%20Stack%20Developer%20%7C%20React%20%7C%20Node.js%20%7C%20MongoDB&descAlignY=58&descSize=16&animation=fadeIn" />

<!-- Typing Animation -->
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=A78BFA&center=true&vCenter=true&width=600&lines=Hey+there!+I'm+Sonal+%F0%9F%91%8B;Full+Stack+Web+Developer;React+%2B+Node.js+Enthusiast;Building+cool+products+at+Digitrix+Agency;Open+to+collaborate+%F0%9F%9A%80" alt="Typing SVG" />
</a>
...
const sonal = {
  ...
  education   : "B.Sc. Information Technology — Mumbai University (2021–2024)",
  currentWork : "Digitrix Agency, Vasai",
  focus       : ["React.js", "Next.js", "Node.js", "MongoDB"],
  hobbies     : ["Building apps", "Game dev", "Open source"],
  funFact     : "I built a Zelda-inspired RPG game as my final year project 🗡️",
};
```
...
### 🏢 Digitrix Agency, Vasai — Full Stack Developer

| Project | Duration | Highlights |
|---------|----------|------------|
| **CreateReceipt** 🧾 | Jun 2025 – Jul 2025 | Dynamic PDF generation, reusable React UI components, HTML-to-PDF with custom backend API |
| **DulyPlan** 📅 | Aug 2025 – Present | Drag-and-drop calendar (React DnD), multi-view scheduling, org & social account management flows |
...
<a href="https://github.com/sonal017/codequest">
  <img width="48%" src="https://github-readme-stats.vercel.app/api/pin/?username=sonal017&repo=codequest&theme=tokyonight&hide_border=true&bg_color=0d1117&title_color=a78bfa&text_color=c9d1d9&icon_color=a78bfa" />
</a>
...
> A full-stack Q&A platform with user auth, question posting, answers, voting, and tagging.
> **Stack:** `React` `Node.js` `Express.js` `MongoDB`

### 🎮 2D RPG Game — Legend of Zelda Inspired *(Final Year Project)*
> A 2D RPG game built in Python featuring character movement, enemy AI, collision detection & level progression.
> **Stack:** `Python` `Pygame`
